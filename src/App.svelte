...
<main class="min-h-screen flex items-top justify-center bg-grey-100">
<div class="relative top-10">
  ...
  -->
  {#if isOpen}
  <div class="absolute left-1/2 z-10 mt-5 flex w-screen max-w-max -translate-x-1/2 px-4 transition ease-out duration-200 opacity-100 translate-y-0">
